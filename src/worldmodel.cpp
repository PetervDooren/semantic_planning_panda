...
HorizontalTopology WorldModel::determineHorizontalTopology(double x, double y)
{
    ...
    double max_max_x = max_position[0] + length;
    double min_max_x = min_position[0] + length;
    double max_min_x = max_position[0] - length;
    double min_min_x = min_position[0] - length;

    double max_max_y = max_position[1] + width;
    double min_max_y = min_position[1] + width;
    double max_min_y = max_position[1] - width;
    double min_min_y = min_position[1] - width;
...
Eigen::Vector2d WorldModel::out(double x, double y)
{
    ...
    double dy = y-(max_position[0] + min_position[0])/2;
